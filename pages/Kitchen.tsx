    ...
    <div className="p-6 md:p-10 h-full overflow-y-auto bg-slate-50/50 no-scrollbar">
      <div className="mb-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
        ...
        <div className="flex gap-3">
           <div className="bg-white border border-slate-100 px-6 py-3 rounded-2xl text-xs font-bold uppercase tracking-widest text-slate-400 shadow-sm flex items-center gap-3">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 gap-8">
        {activeOrders.length === 0 ? (
            <div className="col-span-full flex flex-col items-center justify-center h-96 bg-white rounded-[2.5rem] shadow-sm border border-slate-100">
                <CheckCircle size={64} strokeWidth={1} className="text-slate-100 mb-6" />
                <h3 className="text-xl font-bold text-slate-300 uppercase tracking-widest">Kitchen Clear</h3>
          ...
          return (
          <div key={order.id} className="group relative rounded-[2.5rem] shadow-sm p-8 bg-white flex flex-col h-full transition-all hover:shadow-2xl border border-slate-100 hover:border-slate-200 min-h-[400px]">
