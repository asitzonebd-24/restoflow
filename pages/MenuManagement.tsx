    ...
    <div className="p-6 md:p-10 h-full overflow-y-auto bg-slate-50/50 no-scrollbar">
      ...
      <div className="mb-10 flex flex-col md:flex-row gap-6 items-center">
        ...
        <div className="flex gap-4 w-full md:w-auto">
          <div className="bg-white border border-slate-100 px-6 py-4 rounded-3xl shadow-sm flex-1 md:flex-none">
          ...
          return (
            <div key={cat} className="space-y-10">
              <div className="flex items-center gap-6">
                 ...
                 <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest bg-white border border-slate-100 px-5 py-2 rounded-full shadow-sm">{itemsInCat.length} Items</span>
              </div>
              
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 gap-8">
                {itemsInCat.map(item => (
                  <div key={item.id} className="group bg-white rounded-[2rem] border border-slate-100 overflow-hidden transition-all hover:shadow-2xl hover:border-slate-200 flex flex-col">
                    ...
                    <div className="p-7 flex-1 flex flex-col">
                      ...
                      <div className="mt-auto pt-6 flex items-center justify-between border-t border-slate-50">
                        ...
                        <button 
                          ...
                          className="text-[10px] font-bold text-slate-400 uppercase tracking-widest hover:text-slate-900 transition-colors bg-slate-50 px-3 py-1 rounded-lg hover:bg-slate-100"
                        >
                          Toggle
                        </button>
                      </div>
